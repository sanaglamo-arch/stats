...
const en = {
  ...
  // Full stat page (Phase 11, p11-5)
  profileFullStats: "Full season × competition",
  profileFullStatsHint: "Every season, every metric. Switch competition tabs and Core/Advanced depth.",
  profileExpand: "Show competitions",
  profileCollapse: "Hide competitions",
  profileExpandHint: "Expand any season to see its individual competitions (La Liga, Copa del Rey, Champions League …).",
  profileShooting: "Shooting & xG",
  profileShootingHint: "Shot volume, accuracy and the modern expected-goals picture.",
  profileXgNote: "xG · xA · xG-performance available for 2014+ seasons only — earlier seasons show n/a, never a fabricated zero.",
  profileDiscipline: "Discipline",
  profileDisciplineHint: "Cards are not carried in this dataset.",
  profileDisciplineNote: "Yellow/red cards are 0 across all 222 rows in the seed dataset, so they are shown as n/a rather than a misleading zero.",
  profileAgeProgression: "Age progression",
  profileAgeProgressionHint: "Goals and goal contributions by age during the season.",
  profileByLeague: "By league",
  profileByLeagueHint: "Domestic-league output, leagues the player actually played in.",
  profileAsOf: "Data as of {date}",

  // ── COMPREHENSIVE STATS BODY (Phase 11, p11-2) ────────────────────────
  statsTitle: "Full statistics",
  statsScope: "{rows} rows · {seasons} seasons · {types} competition types · {clubs} clubs — all on screen",
  statsCareerTitle: "Career — every number",
  statsCareerHint: "Head-to-head on every metric. The leader is highlighted in their colour.",
  statsTierLabel: "Metric depth",
  statsTierCore: "Core",
  statsTierAdvanced: "Advanced",
  statsSeasonTitle: "Season by season — side by side",
  statsSeasonHint: "All {seasons} seasons. Where a player didn't feature, an honest dash — never a fabricated zero.",
  statsCutsLabel: "Breakdown",
  statsCutSeasons: "By season",
  statsCutClubs: "By club",
  statsCutTypes: "By competition",
  statsCutTotals: "Totals",
  statsColDelta: "Δ",
  statsColGA: "G+A",
  statsColClub: "Club / Team",
  statsCareerRow: "Career",
  statsDidNotPlay: "did not play",
  statsNa: "n/a",
  statsBadge2014: "from 2014",
  statsBadgeMissing: "not recorded",
  statsDistributed: "distributed",
  statsClubsNote: "Every club and national team in the dataset. National-team season splits are distributed (illustrative); career totals are cross-checked.",
  statsTotalsNote: "Career totals for the selected competition tab. Read-only — the verdict lives only in the arena above.",
  statsEntryDeepTitle: "Full head-to-head →",
  statsEntryDeepDesc: "Every metric × every season × every competition. Deltas, who-leads, same-age alignment.",
...
const ru: Dictionary = {
  ...
  // Full stat page (Phase 11, p11-5)
  profileFullStats: "Все сезоны × турниры",
  profileFullStatsHint: "Каждый сезон, каждая метрика. Переключайте табы турниров и глубину «Основные/Расширенные».",
  profileExpand: "Показать турниры",
  profileCollapse: "Скрыть турниры",
  profileExpandHint: "Разверните любой сезон, чтобы увидеть отдельные турниры (Ла Лига, Кубок Короля, Лига чемпионов …).",
  profileShooting: "Удары и xG",
  profileShootingHint: "Объём ударов, точность и современная картина ожидаемых голов.",
  profileXgNote: "xG · xA · xG-перформанс доступны только с сезона 2014/15 — ранее показываем н/д, а не выдуманный ноль.",
  profileDiscipline: "Дисциплина",
  profileDisciplineHint: "Карточки в этом наборе данных не заполнены.",
  profileDisciplineNote: "Жёлтые/красные карточки равны 0 во всех 222 строках seed-набора, поэтому показываем н/д, а не вводящий в заблуждение ноль.",
  profileAgeProgression: "Прогресс по возрасту",
  profileAgeProgressionHint: "Голы и результативные действия по возрасту в сезоне.",
  profileByLeague: "По лигам",
  profileByLeagueHint: "Показатели в национальных лигах, где игрок реально выступал.",
  profileAsOf: "Данные на {date}",

  // ── COMPREHENSIVE STATS BODY (Phase 11, p11-2) ────────────────────────
  statsTitle: "Полная статистика",
  statsScope: "{rows} строки · {seasons} сезона · {types} типов турниров · {clubs} клубов — всё на экране",
  statsCareerTitle: "Карьера — все цифры",
  statsCareerHint: "Прямое сравнение по каждой метрике. Лидер подсвечен цветом игрока.",
  statsTierLabel: "Глубина метрик",
  statsTierCore: "Основные",
  statsTierAdvanced: "Расширенные",
  statsSeasonTitle: "Сезон за сезоном — бок о бок",
  statsSeasonHint: "Все {seasons} сезона. Где игрок не выступал — честный прочерк, а не выдуманный ноль.",
  statsCutsLabel: "Разрез",
  statsCutSeasons: "По сезонам",
  statsCutClubs: "По клубам",
  statsCutTypes: "По турнирам",
  statsCutTotals: "Тоталы",
  statsColDelta: "Δ",
  statsColGA: "Г+П",
  statsColClub: "Клуб / Сборная",
  statsCareerRow: "Карьера",
  statsDidNotPlay: "не играл",
  statsNa: "н/д",
  statsBadge2014: "с 2014",
  statsBadgeMissing: "нет данных",
  statsDistributed: "распределено",
  statsClubsNote: "Все клубы и сборные из набора данных. Сезонная разбивка сборных распределена (иллюстративно); карьерные тоталы кросс-проверены.",
  statsTotalsNote: "Карьерные тоталы для выбранного таба турниров. Только для чтения — вердикт живёт только на арене сверху.",
  statsEntryDeepTitle: "Полный head-to-head →",
  statsEntryDeepDesc: "Все метрики × все сезоны × все турниры. Дельты, «кто ведёт», выравнивание по возрасту.",
